...
namespace Datos
{
    public class CRUD
    {
        ...
        //public string InsertarProyecto(Object mainObject, bool autoIncrement1,List<ProyectoEstudiante> listaEstudiantes )
        //{
        ...
        //    //Último Id
        //    //************************************
        //    MySqlCommand Comando_tmp = new MySqlCommand("SELECT MAX(idProyecto)+1 AS IdMax FROM Proyecto", SqlCon2);
        //    Comando_tmp.CommandType = CommandType.Text;
        //    SqlCon2.Open();
        //    string canti = Comando_tmp.ExecuteScalar().ToString();
        //    long lastId = 0;
        ...
        //        if (campos1.Count() == valores1.Count())
        //        {

        //            for (int i = 0; i <= valores1.Count() - 1; i++)
        //                listaValores1.Add("?Valor_" + i.ToString());
        ...
        //            for (int i = 0; i <= valores1.Count() - 1; i++)
        //                if (i == 0)
        //                    Comando.Parameters.AddWithValue("?Valor_" + i.ToString(), lastId);
        //                else
        //                    Comando.Parameters.AddWithValue("?Valor_" + i.ToString(), valores1[i]);

        //            Comando.ExecuteNonQuery();

        //            foreach (var item in listaEstudiantes)
        //            {
        //                sqlSentence2 = "INSERT INTO PROYECTOESTUDIANTE(idProyecto,idEstudiante) values(" + lastId + "," + item.idEstudiante + ");";
        //                Comando = new MySqlCommand(sqlSentence2, SqlCon);
        //                NumFilasAfectadas = Comando.ExecuteNonQuery();
        //            }                    
        //            transaccion.Commit();
        ...
        //public string ActualizarProyecto(Object obj, List<ProyectoEstudiante> listaEstudiantes)
        //{
        ...
        //            string sqlSentence2 = "DELETE FROM PROYECTOESTUDIANTE WHERE idProyecto=" + listaEstudiantes[0].idProyecto + ";";
        //            Comando = new MySqlCommand(sqlSentence2, SqlCon);
        //            NumFilasAfectadas = Comando.ExecuteNonQuery();

        //            foreach (var item in listaEstudiantes)
        //            {
        //                string sqlSentence3 = "INSERT INTO PROYECTOESTUDIANTE(idProyecto,idEstudiante) values(" + item.idProyecto + "," + item.idEstudiante + ");";
        //                Comando = new MySqlCommand(sqlSentence3, SqlCon);
        //                NumFilasAfectadas = Comando.ExecuteNonQuery();
        //            }
        //            transaccion.Commit();
        //        }
